...
To allow the use of \gls{fpga} in applications where it will be subjected to harsh environments, as in space, two options are available. The use of space-grade components, that are engineered for radiation tolerance \cite{Battezzati2010}, \cite{DiMascio2019} or \gls{cots} \glspl{fpga} that are not engineered to withstand harsh environments, but could offer advantages in cost and performance \cite{Barbosa2021}. Advances in error mitigation techniques, such as redundancy and error correction, have made it possible to consider COTS devices for space applications \cite{10207287}, \cite{Brosser2014}. 
