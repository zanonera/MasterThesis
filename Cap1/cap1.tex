...
\glspl{sram}-based \glspl{fpga} offer an advantage through their capability to be dynamically and partially reconfigured at run time, making them considerably more powerful and flexible than non-dynamically reconfigurable technologies such as flash- or antifuse-based \glspl{fpga} \cite{Bernardeschi2015}.
