...
\gls{dpr} and memory scrubbing emerge as a powerful complement to redundancy techniques by allowing the selective repair of faulty modules without interrupting the functionality of the system. When combined with systematic \acrlong{fi}, researchers can accurately evaluate the resilience of \gls{fpga}-based systems and validate mitigation strategies under realistic conditions. 
...
\begin{itemize}
    ...
    \item \hyperref[sec:cap2]{\textbf{Chapter 2 – Concepts and Literature Review:}} Reviews the state-of-the-art in fault-tolerant \gls{fpga} design, including redundancy schemes, memory scrubbing, \acrlong{dpr}, and \acrlong{fi} methodologies. This chapter provides a foundation for understanding the theoretical and practical aspects of reliability in \gls{sram}-based \gls{fpga} systems.
