...
\begin{itemize}
    ...
    \item Apply \gls{ms} to maintain the integrity of the configuration data in \gls{fpga} \gls{cram}.
...
\begin{itemize}
    ...
    \item \hyperref[sec:cap2]{\textbf{Chapter 2 – Concepts and Literature Review:}} Reviews the state-of-the-art in fault-tolerant \gls{fpga} design, including redundancy schemes, \acrlong{ms}, \acrlong{dpr}, and \acrlong{fi} methodologies. This chapter provides a foundation for understanding the theoretical and practical aspects of reliability in \gls{sram}-based \gls{fpga} systems.
    ...
    \item \hyperref[sec:cap4]{\textbf{Chapter 4 – Development Methodology:}} Describes the design and implementation methodology of the proposed system, including benchmark selection, design of the \gls{fpga} architecture, integration of \gls{nmr} and \gls{dpr}, and setup of the fault injection framework.
