...
The main contributions of this work can be summarized as follows:
    \begin{itemize}
        \item {A fault-tolerant \gls{fpga} design methodology integrating \gls{nmr}, \gls{dpr}, and \gls{fi} for reliability evaluation;}
...
\begin{itemize}
    ...
    \item \hyperref[sec:cap2]{\textbf{Chapter 2 – Concepts and Literature Review:}} Reviews the state-of-the-art in fault-tolerant \gls{fpga} design, including redundancy schemes, memory scrubbing, partial dynamic reconfiguration, and fault injection methodologies. This chapter provides a foundation for understanding the theoretical and practical aspects of reliability in \gls{sram}-based \gls{fpga} systems.
