...
\glspl{fpga} are successful platforms because they combine the flexibility of software with the speed of hardware, providing customizable computation cores and high throughput processing of data streams. They are particularly attractive compared to \glspl{asic} due to their lower development time and costs, and the ability to be reconfigured \citeauthor{8524728}.
