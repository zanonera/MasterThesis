...
& \gls{tmr} \& \gls{fi}
& Emulation (\gls{fi} by Sabouteurs)
& Less Complex \gls{fi}
& Needs to change the \gls{hdl} \\
\\
\textcite{Yaman2022} %%OK
& \gls{tmr}
& Simulation (\gls{fi} by Mutants))
& Uses Word Voter
& Neither Emulation Emulation and Physical. No \gls{dpr} \\
\\
\textcite{Wubs2023} %%OK
& \gls{nmr} \& \gls{semip}
& Emulation (\gls{semip}) 
& No \gls{dpr} \& No Physical 
...
& Long Times to perform \gls{fi} logs \\
\\
\textcite{Rao2023}
...
& \gls{tmr} \&  
& Physical 
& Uses Other \gls{fpga} vendors 
& Only explores \gls{tmr} \\
\\
% \textcite{Garg2024}
...
& \gls{tmr} \& Memory with \gls{ecc} \& Placement
& Emulation and Physical 
& Evaluates Linux capable Risc-V 32 
& No \gls{dpr} \\
\\
\textcite{Cano-Paez2025} %%OK
& \gls{tmr} \& \gls{dpr} \& gls{semip} \gls{fi}
& Emulation and Physical 
& Campaign with Protons and Neutrons 
& Design complexity \\
\\
\textbf{This Work}  %%OK
& \gls{nmr} \& \gls{dpr} \& \gls{semip} \& \gls{fi}
& Emulation (\gls{semip}) + Software-in-the-loop evaluation 
