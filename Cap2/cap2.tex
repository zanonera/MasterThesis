...
\\
\textcite{Wubs2023} %%OK
& \acrshort{dsp} \& \acrshort{nmr} \& \acrshort{semip}
...
& Simulation 
& Added \acrshort{secded} \acrshort{ecc} to PicoRV32I 
...
\\
\textbf{This Work}  %%OK
& \acrshort{dsp} \& \acrshort{nmr} (Coarse Grain) \& \acrshort{dpr} \& \acrshort{semip} \& \acrshort{fi} \& \acrshort{soc} with \acrshort{axi} bus
& Emulation (\acrshort{fi} with \acrshort{semip}) \& Simulation with Mutants 
& Low downtime, redundancy \& adaptive repair \& heterogeneous computing support
