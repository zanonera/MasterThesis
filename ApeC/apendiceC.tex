...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ApeC/sem_ip_logic.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ApeC/sem_ip_logic2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ApeC/sem_ip_specific.png}
