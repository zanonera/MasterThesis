...
\begin{figure}[H]
    ...
    \caption{(a) Menu Selection of the \gls{pr} of the blanking bitstream (b) Menu indication that the \gls{pr} failed to set a new bitstream.}
...
\begin{figure}[H]
    ...
    \caption{(a) Menu Selection of the multiplier to be applied to the \gls{pr} (b) Multiplication check on \gls{hw} and \gls{sw}.}
...
\begin{figure}[H]
    ...
    \caption{(a) Menu Selection of the adder to be applied to the \gls{pr} (b) Addition check on \gls{hw} and \gls{sw}.}
...
\begin{figure}[H]
    ...
    \caption{(a) \gls{hw} addition error after injection of an bit flip in Region \emph{C0003C440C} (b) Showing the value with other operands for the addition.}
...
\begin{figure}[h]
    ...
    \caption{Automated \gls{fi} result without the reprogram ability.}
...
\begin{figure}[h]
    ...
    \caption{Automated \gls{fi} result with the reprogram ability.}
