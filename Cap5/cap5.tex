...
The design was physically divided into three \textit{pblocks}: one dedicated to the serial interface (UART), another shared between Cores~\#2 \&~\#3, and one exclusively reserved for Core~\#1 (My \acrshort{dut} pblock in region X1Y0), as shown in Figure~\ref{fig:2pblocks}.
