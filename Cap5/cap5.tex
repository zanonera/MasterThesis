...
The recovery coverage (\(RC\)) quantifies the fraction of injected faults that were successfully masked, corrected, or recovered by the mitigation strategies implemented. It is defined by Equation~\ref{eq:fault_coverage}:
...
\begin{itemize}
    \item The recovery coverage increased from less than 10\% in unprotected designs to more than 99\% when scrubbing and redundancy were combined.
