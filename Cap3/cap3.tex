...
Although they can be temporarily embedded in the hardware for experimental purposes, both methods modify the original functionality and must be removed prior to generating the final bitstream. 
Among the most common \gls{hdl}-based fault injection approaches are the use of \textit{saboteurs} and \textit{mutants}:
...
\begin{itemize}
    ...
    When activated, a saboteur intentionally forces faults such as stuck-at, bit-flip, or delay conditions, reproducing abnormal behavior in the simulated circuit. 
