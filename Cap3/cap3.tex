...
\caption{\acrshort{fpga} Structure. Adapted from \textcite{Marioli2010}.}\label{fpga-arch}
\end{figure}
...
\caption{\acrshort{fpga} specialized resources. Reproduced from \textcite{AMD_UG474}.}\label{fpga-column-asmbl}
\end{figure}
...
The type of \gls{cram} used dictates the characteristics of the device:
...
\caption{Simple representation of the \acrshort{fpga} bitstream structure.}\label{fpga-simple-bitstream}
\end{figure}
...
\end{tikzpicture}
\end{adjustbox}
\caption{Classification of \acrlong{see} subtypes.}
...
\caption{Illustration of a \acrshort{seu} effect in a \acrshort{lut}'s \acrshort{fpga} . Adapted from \textcite{Mousavi2023_MTTR_FPGA_Scrubbing}.}\label{fpga-seu-and}
\end{figure}
...
\caption{\acrshort{sbu} and \acrshort{mbu} representations in a \acrshort{fpga} \acrshort{cram}. Reproduced from \textcite{Aguiar2025_SEE_Space_to_Accelerator}.}\label{fpga-seu-and-sbu-mbu}
\end{figure}
...
\caption{Representation of different types of bits in the \acrshort{fpga} \acrshort{cram} due to its criticality. Reproduced from \textcite{Adria2023}.}\label{fpga-bits-definition}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Representation of the \acrlong{cgtmr}}
    \label{fig:cgtmr}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Representation of the \acrlong{fgtmr}}
    \label{fig:fgtmr}
\end{figure}
...
\begin{figure}
    ...
    \caption{Basic Principle of \acrshort{dpr}.Reproduced from \cite{Xilinx_UG702_PR}.}
...
\begin{figure}[H]
    ...
    \caption{Scrubbing method available in \acrshort{soc} devices.}
