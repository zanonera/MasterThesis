...
These are the elementary logic blocks used to implement the desired logic functions. The \glspl{clb} (sometimes called Logic Cells or Logic Array Blocks, depending on the manufacturer \gls{fpga}) perform simple combinational and sequential logic.
