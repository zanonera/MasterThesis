...
A \gls{fpga} is a reconfigurable logic device or a programmable \gls{ic} widely used for the implementation of digital systems. It can be reconfigured by the user, even after deployment \cite{Mazzeo2019}, enabling rapid prototyping, hardware acceleration, and long-term design flexibility.
