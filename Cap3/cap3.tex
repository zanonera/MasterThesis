...
Then in Figure~\ref{fpga-seu-and}(b), a \gls{seu} is represented, changing the first value of the 2-input \gls{lut} from $0$ to $1$. Now, the behavior of the circuit changes, as shown in Table~\ref{tab:logic_gates}, from a gate $AND$ to a gate $XNOR$.
