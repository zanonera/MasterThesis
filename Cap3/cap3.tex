...
\node (mbu) [subblock, below of=seu, yshift=-0.5cm] {Multi-Bit Upset (MBU)};
...
\end{tikzpicture}
\end{adjustbox}
\caption{Classification of Single Event Effects (SEE) into Soft SEE and Hard SEE, including Multi-Bit Upset (MBU) as a subtype of SEU.}
...
\begin{figure}
    ...
    \caption{Scrubbing method avaiable in \gls{soc} devices}
