...
\begin{figure}
    ...
    \caption{Block Diagram of the \gls{fir} implementation in Vivado. The \gls{fir} is in the block intitulated "My Design" and the \gls{sem} wrapper contains the scrubber (\gls{semip} and the ARM porocessor.}
...
\begin{figure}
    ...
    \caption{Block Diagram, in detal, of the \gls{fir} implementation in Vivado. The \gls{dmr} is presengted and the circuito to detect if the modules has the correct outputs}
